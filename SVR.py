...
def Fit_SVR(c_val, IndVar, Target, Stats):
    ...
    # Importing Data Base
    DB_Training = np.loadtxt("Trainv2.txt")
    DB_Testing = np.loadtxt("Valv2v2.txt")
    ...
    np.savetxt('Models_1_3_6_9_10/Sim_Res_Validation_%s_%s.txt'%(c_val,Target), Results, fmt='%3.4e', delimiter='\t', newline='\n')      
...
StatsDsv = [3252] # EC 0.5, EC 1, EC 2, EC 4, EC 8
CconstVec = [500,1000,5000]
